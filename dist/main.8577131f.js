...
jQuery(".test").find(".child").addClass("blue").addClass("green").addClass("orange").end().addClass("yellow");
...
var div1 = document.querySelector(".test"); //div1是DOM构造的对象，只能调用DOM API
var div2 = $(".test"); //div2是jQuery构造的对象
...
//# sourceMappingURL=/main.8577131f.map